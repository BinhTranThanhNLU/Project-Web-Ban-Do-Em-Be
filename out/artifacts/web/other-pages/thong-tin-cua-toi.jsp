...
<head>
  ...
  <link rel="stylesheet" href="../static/css/thong-tin-cua-toi.css" />
</head>
    ...
    <div class="sidebar">
      <div class="profile">
        ...
        <div>
          ...
          <a href="./thong-tin-cua-toi.jsp"> Sửa Hồ Sơ </a>
        </div>
      </div>
      <ul class="menu">
        <!-- <li>
        ...
        <li>
          <a href="./thong-tin-cua-toi.jsp" class="active">
            <i class="fas fa-user"> </i>
            Tài Khoản Của Tôi
          </a>
        </li>
        <li>
          <a href="./don-hang-cua-toi.jsp">
            <i class="fas fa-shopping-cart"> </i>
            Đơn Hàng Của Tôi
          </a>
        </li>
    ...
    <div class="content">
      ...
      <div class="form-container">
        ...
        <form class="personal-data-form">
          <!-- Name -->
          <label for="first-name">1. Họ và Tên</label>
