        ...
        <div class="cart-container-cart">
            <div class="cart-container-left">
                <table>
                    ...
                    <tr>
                        <td>
                            <img
                                    src="../static/images/big-yem-truoc.jpg"
                                    alt="" />
                        </td>
                        <td>
                            <p>váy hoá</p>
            ...
            <div class="cart-container-right">
                ...
                <div class="cart-container-right-button">
                    <a href="./thong-tin-giao-hang.jsp" class="btn-payment">THANH TOÁN</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="section-footer">
    <div class="footer">
        <div class="footer-column">
            <img alt="Little Whale Logo" height="50" src="../static/images/logo.png" width="100" />
            <p>
