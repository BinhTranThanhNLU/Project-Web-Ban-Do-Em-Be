...
<head>
  ...
  <link rel="stylesheet" href="../static/css/quenmk.css">
  ...
  <div class="form-login">
    <form action="" method="POST" class="form" id="form-2">
      ...
      <div class="form-group f-term">
        <label for="agree" class="form-label">bạn đã có tài khoản? Đăng nhập <a href="./dangnhap.jsp">đây</a></label>
        <span class="form-message"></span>
      </div>

      <div class="sign-up">
        <div class="dangnhap">
          <a href="./quentk.jsp" >Tìm Kiếm</a>
        </div>
        <div class="dangki">
