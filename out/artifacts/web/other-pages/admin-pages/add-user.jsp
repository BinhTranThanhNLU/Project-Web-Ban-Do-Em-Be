...
<head>
  ...
  <link rel="stylesheet" href="../../web/src/main/webapp/static/css/admin-css/add-order.css" />
</head>
<body>
<div class="container-scroller">
  ...
  <navbar class="navbar-left" id="navbar-left">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="menu-item">
        <a class="menu-link" href="table-data-product.html">
    ...
    <div class="container">
      ...
      <form>
        <div class="form-group">
          ...
          />
          <label for="quantity">Họ và tên </label>
          <input
                  type="text"
                  id="quantity"
                  name="quantity"
          ...
          />
          <label for="quantity">Địa chỉ</label>
          <input
                  type="text"
                  id="quantity"
                  name="quantity"
