...
<head>
    ...
    <link rel="stylesheet" href="../web/src/main/webapp/static/css/card-product.css">
    <link rel="stylesheet" href="../web/src/main/webapp/static/css/do-be-gai.css">
</head>
    ...
    <div class="bread-crumb-container">
        <div class="bread-crumb-row">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="./be-gai.html" itemprop="url" target="_self"><span itemprop="title">Thời Trang Bé Gái</span></a>
                    <span class="">&nbsp;/&nbsp;</span>
                </li>

                <li>
                    <a href="./do-be-gai.html" itemprop="url" target="_self"><span itemprop="title">Đầm-Váy Bé Gái</span></a>
                    <span class="">&nbsp;/&nbsp;</span>
                </li>
...
<section class="section-footer">
    <div class="footer">
        ...
        <div class="footer-column">
            ...
            <br />
            <a href="./chinhsachkhachangthanthiet.html">Chính sách Khách hàng thân thiết</a>
            <br />
            <a href="./giaohang-phigiaohang.html">Giao hàng &amp; phí giao hàng</a>
            <br />
...
<script src="../js/interaction-dobegai.js"></script>
