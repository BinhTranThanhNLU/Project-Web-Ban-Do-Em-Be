    ...
    <div class="sidebar">
      <div class="profile">
        ...
        <div>
          ...
          <a href="./thong-tin-cua-toi.jsp">&emsp;Sửa Hồ Sơ </a>
        </div>
      </div>
      <ul class="menu">
        <!-- <li>
        ...
        <li>
          <a href="./thong-tin-cua-toi.jsp">
            <i class="fas fa-user"> </i>
            Tài Khoản Của Tôi
          </a>
        </li>
        <li>
          <a class="active" href="./don-hang-cua-toi.jsp">
            <i class="fas fa-shopping-cart"> </i>
            Đơn Hàng Của Tôi
          </a>
        </li>
...
<script src="../static/js/lichsumua.js"></script>
