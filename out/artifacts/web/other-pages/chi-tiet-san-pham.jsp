  ...
  <div class="bread-crumb-container">
    <div class="bread-crumb-row">
      <ul class="breadcrumb">
        ...
        <li>
          <a href="./be-gai.jsp" itemprop="url" target="_self"
        ...
        <li>
          <a href="./tat-ca-dam-vay.jsp" itemprop="url" target="_self"
  ...
  <div class="product-page">
    ...
    <div class="product-slider">
      <div class="product-image">
        <img
                src="../static/images/big-bodonguoinhen.jpg"
      ...
      <div class="product-image">
        <img
                src="../static/images/big-bodonguoinhene-vuong.jpg"
    ...
    <div class="product-info">
      ...
      <div class="color-thumbnails">
        <div class="thumbnail selected">
          <img src="../static/images/big-bodonguoinhen.jpg" alt="Green Dress" />
        </div>
        <div class="thumbnail">
          <img src="../static/images/big-ao-khung-long-1red.jpg" alt="Red Dress" />
        </div>
      </div>
      ...
      <div class="action-buttons">
        <a href="./thong-tin-giao-hang.jsp" class="buy-now">MUA NGAY</a>
      </div>
      ...
      <div class="product-description">
        ...
        <div class="description-content">
          <p>
            Xuất xứ Trung Quốc,95% cotton,độ tuổi từ 1-4 tuổi
          </p>
        </div>
      </div>
    </div>
...
<script src="../static/js/interaction-chi-tiet-san-pham.js"></script>
</body>
</html>
